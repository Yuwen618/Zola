...
function getDividendBalance(address player) external returns (uint256);
function getWinBalance(address player) view external returns (uint256);
}

contract StayToEnd1031 is owned {
	using SafeMath for uint256;
	
	uint256 public INTERVAL = 7*24*60*60;//interval 24*7 hours, after that the last player will win
	...
	constructor() public{
		...
		totalInPool = 0;
		ZolaXAddress = 0xff3d5cc0eB37aE238AA009A88415DDa621DD1Da5;
		ZolaXImpl = ZolaXEntry(ZolaXAddress);
		setZGTToken(0xa99CCb1dCf167b05680e7B9Ac39EfE9a76Ed8158);
