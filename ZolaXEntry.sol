...
contract ZolaXEntryOf1029 is owned {
	...
	mapping(address => uint256) public ZGTDepositBalance;//not used
	...
	constructor() public{
		ZGTTokenAddress  = 0xa99CCb1dCf167b05680e7B9Ac39EfE9a76Ed8158;
		ZGTToken = ERC20(ZGTTokenAddress);
		
		ZSTSaleImplAddress = 0x2cC6f34B1500b36cBCe602B4b06CFA75119A64c1;//sale impl
		zstSale = ZSTSaleContract(ZSTSaleImplAddress);
		
		zstToken = ZSTToken(0x27d95406658120096768172621c4C6F3CF33861d);
